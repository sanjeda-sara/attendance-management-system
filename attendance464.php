<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO attendance464(id, name, attendance_status, date)
...
<body>
        ...
        <center>
            ...
            <center>
                    <label>Course Code: CSE464</label><br>
                    <label>Course Instructor: Dr. Mohammad Rezwanul Haque [DMRH]</label><br><br>
            </center>
            <?php if($flag){ ?>
